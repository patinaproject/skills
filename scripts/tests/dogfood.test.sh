#!/usr/bin/env bash
# dogfood.test.sh — Asserts that all seven in-repo skills are discoverable
...
# Exit 0: all seven skills pass all assertions.
...
echo ""
echo "OK: all seven in-repo skills discoverable via flat layout"
exit 0
