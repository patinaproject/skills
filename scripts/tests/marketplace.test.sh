...
expected_marketplace_skills='["./skills/scaffold-repository","./skills/using-github","./skills/install-skills","./skills/grill-to-spec","./skills/design-by-contract","./skills/grill-system-design","./skills/review-system-design","./skills/writing-for-patina-mode"]'
