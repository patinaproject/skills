...
test -n "$(read_frontmatter_field skills/gather-evidence/SKILL.md description)"
test -z "$(read_frontmatter_field skills/gather-evidence/SKILL.md disable-model-invocation)"
test "$(read_frontmatter_field skills/patina-mode/SKILL.md disable-model-invocation)" = 'true'
