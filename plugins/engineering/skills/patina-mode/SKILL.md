...
When behavior verification starts, find and invoke the project's
`patinaproject-verify` skill, or its equivalent generated by
**create-verification-skill**, before selecting Claude Code or Codex drivers.
