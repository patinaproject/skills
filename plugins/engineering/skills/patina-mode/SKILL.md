...
- Before publication → run both **code-review** axes on the cleaned, verified, committed head through the common Opening a PR sequence. An incomplete or stale axis stops publication.
