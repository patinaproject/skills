...
4. Pick the worker model from `swarm workers` in `~/.claude/engineering-models.md` when present. Otherwise use the default in [Models](#models). For a model race, name each arm's model up front.
