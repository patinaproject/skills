...
the loop. Missing context is an ordinary absence.
...
10. Report ready-to-merge status or concrete non-ready check dispositions
    without merging. Apply the reporter-fidelity reference for the separate
    evidence handoff.
...
- Keep the reporter-fidelity handoff informational and outside the readiness
  predicate by applying its reference as written.
