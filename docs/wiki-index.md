...
| `Skill-superteam-usage` | Deprecated historical usage walkthrough for `superteam`: teammate roles (Team Lead, Brainstormer, Planner, Executor, Reviewer, Finisher), how to invoke the skill on an issue, and how to hand off between teammates. Source: `skills/superteam/SKILL.md` and `skills/superteam/README.md` (now in-repo). |
...
| `How-Superteam-Runs-End-To-End` | Deprecated historical narrative walkthrough of a full superteam run from issue creation through merged PR. |
...
3. Source content for each page from `skills/<name>/SKILL.md` (for skill usage
   pages) and from `README.md` (for install pages and troubleshooting). Per-skill READMEs
   for the three ex-plugin skills are maintained in-repo at `skills/<name>/README.md`.
   Do not copy the full SKILL.md body — use description and trigger sections only.
